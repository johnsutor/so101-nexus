...
These operate on plain Python floats so the MuJoCo backend can call them
after scalar extraction, and a tensor backend such as the planned MuJoCo Warp
backend can reimplement the formulas in tensor form using the same logic.
"""
