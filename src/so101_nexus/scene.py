...
dynamics will not be bit-identical to the CPU backend. For contact-free tasks
(reach) the only effect is the integrator on free arm motion.
"""
...
def build_reach_scene_xml(
    ...
    *,
    ...
    """Build the reach-scene MJCF (robot + floor + target site).
