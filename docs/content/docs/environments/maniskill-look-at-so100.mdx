---
title: ManiSkillLookAtSO100-v1
description: Orient the TCP toward a target object with the SO-100 arm on the ManiSkill backend.
---

# ManiSkillLookAtSO100-v1

Orient the robot's end-effector toward a randomly placed target object using the SO-100 robot arm in ManiSkill.

## Overview

| Property | Value |
|----------|-------|
| Environment ID | `ManiSkillLookAtSO100-v1` |
| Backend | ManiSkill |
| Robot | SO-100 |
...
env = gym.make("ManiSkillLookAtSO100-v1", obs_mode="state", num_envs=1)
```
