...
>
  <source
    src="https://huggingface.co/datasets/johnsutor/MuJoCoPickLift/resolve/main/videos/observation.images.wrist/chunk-000/file-000.mp4"
    type="video/mp4"
  />
  Open the
  <a href="https://huggingface.co/spaces/lerobot/visualize_dataset?path=%2Fjohnsutor%2FMuJoCoPickLift%2Fepisode_0">
...
[Open the dataset](https://huggingface.co/datasets/johnsutor/MuJoCoPickLift) or
[inspect episode 0 in the LeRobot viewer](https://huggingface.co/spaces/lerobot/visualize_dataset?path=%2Fjohnsutor%2FMuJoCoPickLift%2Fepisode_0).
...
Set `ENV_ID = "WarpPickLift-v1"` in the notebook's environment cell. See [Training with PPO](/docs/guides/training-with-ppo) for the local CLI workflow.
