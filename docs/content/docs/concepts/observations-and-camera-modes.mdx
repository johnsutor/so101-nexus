...
| --- | --- | --- |
| PickLift | JointPositions, JointVelocities, EndEffectorPose, GraspState, ObjectPose, ObjectOffset | 30 |
| PickAndPlace | JointPositions, JointVelocities, EndEffectorPose, GraspState, TargetPosition, ObjectPose, ObjectOffset, TargetOffset | 36 |
| StackCube | JointPositions, JointVelocities, EndEffectorPose, GraspState, ObjectPose, ObjectOffset, TargetPosition, TargetOffset | 36 |
| Touch | JointPositions, JointVelocities, EndEffectorPose, GraspState, ObjectPose, ObjectOffset | 30 |
| LookAt | JointPositions, JointVelocities, EndEffectorPose, GazeDirection | 22 |
...
obs, info = env.reset()
print(f"Observation shape: {obs.shape}")  # (30,)
env.close()
