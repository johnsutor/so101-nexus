...
| --- | --- | --- |
| PickLift | JointPositions, EndEffectorPose, GraspState, ObjectPose, ObjectOffset | 24 |
| PickAndPlace | JointPositions, EndEffectorPose, GraspState, TargetPosition, ObjectPose, ObjectOffset, TargetOffset | 30 |
| StackCube | JointPositions, EndEffectorPose, GraspState, ObjectPose, ObjectOffset, TargetPosition, TargetOffset | 30 |
| Touch | JointPositions, EndEffectorPose, GraspState, ObjectPose, ObjectOffset | 24 |
| LookAt | JointPositions, EndEffectorPose, GazeDirection | 16 |
| Move | JointPositions, EndEffectorPose, TargetOffset | 16 |
...
obs, info = env.reset()
print(f"Observation shape: {obs.shape}")  # (24,)
env.close()
