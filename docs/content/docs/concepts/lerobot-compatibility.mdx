...
Use a real SO follower calibration when you want the same normalized action/state semantics as a physical follower. For simulator-only tests, create an explicit synthetic calibration file:
