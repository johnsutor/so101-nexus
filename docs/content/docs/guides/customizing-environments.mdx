...
See the [Configs API reference](/docs/api/configs) for the full list of parameters on `EnvironmentConfig`, `PickConfig`, `PickAndPlaceConfig`, `TouchConfig`, `LookAtConfig`, `MoveConfig`, `RewardConfig`, `RenderConfig`, and `RobotConfig`.
