...
- **[Built-in teleoperation](/docs/guides/teleop-dataset-recording)** -- record LeRobot datasets with a physical SO-100 or SO-101 leader arm, capturing wrist and overhead cameras out of the box
...
- **[Teleop Dataset Recording](/docs/guides/teleop-dataset-recording)** -- collect demonstrations with a physical leader arm and push them to the HuggingFace Hub
