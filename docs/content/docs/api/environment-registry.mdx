...
Returns a list of all SO101-Nexus environment IDs. With both backends imported, the function returns 15 environment IDs (5 MuJoCo + 10 ManiSkill), including the pick-and-place tasks.
