...
description: MolmoActPolicy, the chunked-action adapter for the AllenAI MolmoAct2 SO100/SO101 checkpoint, and RolloutRecorder for capturing its rollouts as a LeRobot dataset.
---
