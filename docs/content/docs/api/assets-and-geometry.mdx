...
holds the URDF/XML retained for the teleop tooling's calibration metadata. Both
the MuJoCo and ManiSkill backends now load the vendored menagerie MJCF instead
...
model under `SO101_menagerie/`. Both the MuJoCo and ManiSkill backends load this
